...
def randomiseImagesAndTags(vectors, tags):
  """
  Return image vectors and tags in random order.
  """
  randomized = list(range(len(tags)))
  random.shuffle(randomized)             
  vectors_r = [vectors[i] for i in randomized]
  tags_r = [tags[i] for i in randomized]
  return vectors_r, tags_r
